#!/usr/bin/env python3
"""Run this once to generate placeholder icons before pnpm tauri dev"""
...
print("Icons created in src-tauri/icons/")
print("Now run: pnpm tauri icon src-tauri/icons/1024x1024.png")
